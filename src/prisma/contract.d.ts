...
export type StorageHash =
  StorageHashBase<'f78717e5f21cfdd38cd6cac60d7b0d4f4d55989d2954b9e300aca0fb7ea8b5b7'>;
export type ExecutionHash =
  ExecutionHashBase<'db8c3e55dd41b53fdefce4579633dda4a3b558b38a2601824618b8104eccf6db'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly CalculationHistory: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly userId: CodecTypes['pg/text@1']['output'];
      readonly moduleType: CodecTypes['pg/text@1']['output'];
      readonly title: CodecTypes['pg/text@1']['output'];
      readonly inputs: CodecTypes['pg/json@1']['output'];
      readonly results: CodecTypes['pg/json@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly CalculationHistory: {
      ...
      readonly moduleType: CodecTypes['pg/text@1']['input'];
      readonly title: CodecTypes['pg/text@1']['input'];
      readonly inputs: CodecTypes['pg/json@1']['input'];
      readonly results: CodecTypes['pg/json@1']['input'];
...
> & {
  ...
  readonly roots: {
    ...
    readonly calculationHistory: {
      ...
      readonly model: 'CalculationHistory';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly CalculationHistory: {
            ...
            readonly storage: {
              readonly table: 'calculationHistory';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly moduleType: { readonly column: 'moduleType' };
                readonly title: { readonly column: 'title' };
                readonly inputs: { readonly column: 'inputs' };
